...
<div class="page-transition flex flex-col items-center justify-center py-12 md:py-20 bg-gradient-to-br from-slate-50 to-blue-50 px-4 md:px-6 min-h-screen pt-24">
  ...
  <div class="bg-white/95 backdrop-blur w-full max-w-5xl rounded-3xl md:rounded-[40px] shadow-2xl overflow-hidden flex flex-col md:flex-row border border-white/40">

    <!-- Left Side - Branding -->
    <div class="md:w-5/12 bg-[#001f3f] p-12 text-white flex flex-col justify-between relative overflow-hidden">
    ...
    <div class="md:w-7/12 p-8 md:p-12 overflow-y-auto max-h-[90vh]">
      ...
      <form method="POST" action="{{ route('register.process') }}" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-1">
              <label class="block text-xs font-extrabold text-slate-600 uppercase tracking-widest mb-2">👤 Username</label>
              <input type="text" name="name" placeholder="Username" value="{{ old('name') }}" class="form-input w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-600" required />
            </div>
            <div class="space-y-1">
              <label class="block text-xs font-extrabold text-slate-600 uppercase tracking-widest mb-2">📝 Nama Lengkap</label>
              <input type="text" name="nama_lengkap" placeholder="Sesuai Ijazah" value="{{ old('nama_lengkap') }}" class="form-input w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-600" required />
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="space-y-1">
                <label class="block text-xs font-extrabold text-slate-600 uppercase tracking-widest mb-2">🎓 NISN/NIK</label>
                <input type="text" name="nisn" placeholder="Nomor Identitas" value="{{ old('nisn') }}" class="form-input w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-600" required />
            </div>
            <div class="space-y-1">
                <label class="block text-xs font-extrabold text-slate-600 uppercase tracking-widest mb-2">⚧ Kelamin</label>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="space-y-1">
            ...
            <input type="text" name="tempat_lahir" placeholder="Kota" value="{{ old('tempat_lahir') }}" class="form-input w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-600" required />
          </div>
          <div class="space-y-1">
            <label class="block text-xs font-extrabold text-slate-600 uppercase tracking-widest mb-2">📅 Tgl Lahir</label>
            <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" class="form-input w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-600" required />
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-1">
                <label class="block text-xs font-extrabold text-slate-600 uppercase tracking-widest mb-2">📧 Email</label>
                <input type="email" name="email" placeholder="anda@gmail.com" value="{{ old('email') }}" class="form-input w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-600" required />
            </div>
            <div class="space-y-1">
                <label class="block text-xs font-extrabold text-slate-600 uppercase tracking-widest mb-2">📱 WhatsApp</label>
                <div class="relative">
                  <span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 text-sm font-bold">+62</span>
                  <input type="tel" name="no_hp" placeholder="812xxx" value="{{ old('no_hp') }}" oninput="formatPhone(this)" class="form-input w-full bg-slate-50 border border-slate-200 rounded-xl pl-14 pr-4 py-3 text-sm focus:outline-none focus:border-blue-600" required />
                </div>
            </div>
        </div>

        <div class="space-y-1">
            <label class="block text-xs font-extrabold text-slate-600 uppercase tracking-widest mb-2">🏠 Alamat Lengkap</label>
            <textarea name="alamat" placeholder="Jl. Nama Jalan, Desa, Kecamatan" rows="2" class="form-input w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-600" required>{{ old('alamat') }}</textarea>
        </div>

        <!-- FOTO PROFIL (PINDAH KE SINI) -->
        <div class="space-y-1">
            <label class="block text-xs font-extrabold text-slate-600 uppercase tracking-widest mb-2">📸 Foto Profil (Opsional)</label>
            <input type="file" name="foto_profile" class="form-input w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:border-blue-600" accept="image/*" />
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="space-y-1">
            ...
            <div class="relative">
                <input type="password" name="password" id="regPassword" placeholder="Min 6 Karakter" class="form-input w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-600" required />
          ...
          <div class="space-y-1">
            ...
            <div class="relative">
                <input type="password" name="password_confirmation" id="regPasswordConf" placeholder="Ulangi Sandi" class="form-input w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-600" required />
