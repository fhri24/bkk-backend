...
@section('content')
    <div
        class="page-transition flex items-center justify-center py-12 md:py-20 bg-gradient-to-br from-slate-50 to-blue-50 px-4 md:px-6 min-h-screen">
        <div
            class="bg-white/95 backdrop-blur w-full max-w-4xl rounded-3xl md:rounded-[40px] shadow-2xl overflow-hidden flex flex-col md:flex-row border border-white/40">
            ...
            <div class="md:w-1/2 bg-[#001f3f] p-12 text-white flex flex-col justify-between relative overflow-hidden">
                ...
                <div>
                    ...
                    <p class="text-blue-200 text-sm leading-relaxed">Bergabunglah dengan ribuan alumni sukses SMKN 1 Garut
                        yang telah berkarir di perusahaan-perusahaan terkemuka.</p>
                </div>
                <div class="space-y-4 pt-10">
                    <div class="flex items-center space-x-4">
                        <div class="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center text-blue-400"><i
            ...
            <div class="md:w-1/2 p-12">
                <div class="flex border-b border-slate-100 mb-8">
                    <div class="flex-1 pb-4 text-sm font-bold border-b-2 border-blue-600 text-blue-600 text-center">Masuk
                    </div>
                </div>
                ...
                <form action="{{ route('login.process') }}" method="POST" class="space-y-6">
                        ...
                        <div class="bg-red-50 border-l-4 border-red-500 rounded-xl p-4 mb-6 animate-pulse">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-red-700 text-sm">{{ $errors->first('nis') }}</p>
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    @if (session('status'))
                        <div class="bg-green-50 border-l-4 border-green-500 rounded-xl p-4 mb-6">
                            <p class="text-green-700 text-sm font-semibold"><i
                                    class="fas fa-check-circle mr-2"></i>{{ session('status') }}</p>
                        </div>
                    @endif
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="passwordInput" placeholder="••••••••"
                                class="form-input w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 pr-12 text-sm focus:outline-none focus:border-blue-600 focus:bg-white focus:ring-2 focus:ring-blue-100"
                                required />
