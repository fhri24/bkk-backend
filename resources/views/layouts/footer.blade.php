        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
                <div class="flex items-center space-x-3 mb-6">
                    <div class="w-14 h-14 flex items-center justify-center overflow-hidden">
                        @if (!empty($schoolProfile) && !empty($schoolProfile->logo_path))
                            <img src="{{ Storage::disk('public')->url($schoolProfile->logo_path) }}"
                                class="w-full h-full object-contain p-1" alt="Logo">
                        @elseif(!empty($schoolProfile) && !empty($schoolProfile->logo))
                            <img src="{{ Storage::disk('public')->url($schoolProfile->logo) }}"
                                class="w-full h-full object-contain p-1" alt="Logo">
                        @else
                ...
                <div class="flex space-x-4">
                    @if (!empty($schoolProfile) && !empty($schoolProfile->instagram))
                    ...
                    @if (!empty($schoolProfile) && !empty($schoolProfile->facebook))
                    ...
                    @if (!empty($schoolProfile) && !empty($schoolProfile->twitter))
                    ...
                    @if (!empty($schoolProfile) && !empty($schoolProfile->youtube))
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    ...
                    <li>
                        <a href="{{ route('public.tips') }}" class="hover:text-blue-400 transition flex items-center">
                            <i class="fas fa-chevron-right text-[10px] mr-2"></i> Tips Karir
                        </a>
                    </li>
                    <li>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    ...
                    <li class="flex items-center">
                        ...
                        @if (!empty($schoolProfile) && !empty($schoolProfile->email))
