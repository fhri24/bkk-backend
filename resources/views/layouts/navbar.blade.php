<nav class="bg-[#001f3f] text-white sticky top-0 z- shadow-xl">
    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-[#001f3f] border-t border-white/10 px-6 py-6 space-y-4">
        ...
        @else
            ...
            <a href="{{ route('public.lowongan') }}" class="block w-full text-left py-2 font-semibold hover:text-blue-400" onclick="closeMobileMenu()">Lowongan</a>
            <a href="{{ route('public.berita') }}" class="block w-full text-left py-2 font-semibold hover:text-blue-400" onclick="closeMobileMenu()">Berita</a>
            <a href="{{ route('public.acara') }}" class="block w-full text-left py-2 font-semibold hover:text-blue-400" onclick="closeMobileMenu()">Acara</a>
            <a href="{{ route('public.tracer') }}" class="block w-full text-left py-2 font-semibold hover:text-blue-400" onclick="closeMobileMenu()">Tracer Study</a>
        @endauth
