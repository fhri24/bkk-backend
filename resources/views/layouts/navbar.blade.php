        ...
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden lg:flex items-center space-x-8 text-sm font-semibold">
                @auth
                    ...
                    <a href="{{ route('public.lowongan') }}" class="nav-btn transition hover:text-blue-400 {{ request()->routeIs('public.lowongan*') || request()->routeIs('student.lowongan*') ? 'text-blue-400 border-b-2 border-blue-400' : '' }}">Lowongan</a>
