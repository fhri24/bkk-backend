        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-3">
            ...
            <a href="#section-identitas"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-700 hover:bg-blue-50 hover:text-blue-600 transition group">
                <span class="w-8 h-8 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition">
            ...
            <a href="#section-kontak"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-700 hover:bg-green-50 hover:text-green-600 transition group">
                <span class="w-8 h-8 rounded-lg bg-green-100 text-green-600 flex items-center justify-center group-hover:bg-green-600 group-hover:text-white transition">
            ...
            <a href="#section-sosmed"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-700 hover:bg-pink-50 hover:text-pink-600 transition group">
                <span class="w-8 h-8 rounded-lg bg-pink-100 text-pink-600 flex items-center justify-center group-hover:bg-pink-600 group-hover:text-white transition">
            ...
            <a href="#section-website"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-700 hover:bg-purple-50 hover:text-purple-600 transition group">
                <span class="w-8 h-8 rounded-lg bg-purple-100 text-purple-600 flex items-center justify-center group-hover:bg-purple-600 group-hover:text-white transition">
            ...
            <div class="flex gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-blue-600 leading-relaxed">
                        Perubahan akan langsung tampil di semua halaman publik setelah disimpan. Cache akan otomatis dibersihkan.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden" id="section-identitas">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-slate-400 mt-2">PNG, JPG, SVG. Maks 2MB.<br>Rekomendasi: 200×200px</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="school_name" id="input-name"
                               value="{{ old('school_name', $profile->school_name ?? '') }}"
                               placeholder="SMKN 1 Garut"
                               class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition @error('school_name') border-red-400 @enderror">
                        @error('school_name')
                            <p class="text-red-500 text-xs mt-1"><i class="fas fa-times-circle mr-1"></i>{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="tagline" id="input-tagline"
                               value="{{ old('tagline', $profile->tagline ?? '') }}"
                               placeholder="Garut Bermartabat"
                        ...
                        <p class="text-xs text-slate-400 mt-1">Tampil di bawah nama sekolah pada navbar dan footer.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="school_address" rows="2"
                                  placeholder="Jl. Cimanuk No. 309A, Garut..."
            ...
            <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden" id="section-website">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-1">Tampil sebagai subtitle di bawah judul beranda dan di footer.</p>
                    </div>
                </div>
            </div>
