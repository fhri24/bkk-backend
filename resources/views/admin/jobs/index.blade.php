...
@section('content')
    ...
    <form method="GET" class="mb-6 grid gap-4 lg:grid-cols-4">
        ...
        <div class="flex items-end">
            <button type="submit"
                class="w-full rounded-2xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white hover:bg-blue-700 transition">Terapkan
                Filter</button>
        </div>
    </form>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="badge-pill badge-info">
                                    {{ ucfirst(str_replace('_', ' ', $job->visibility)) }}
                                </span>
                            </td>
                            <td class="text-center">
