...
@section('content')
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-white border-l-4 border-blue-500 border border-slate-200 rounded-2xl p-5 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-black text-blue-600">{{ $kuliah }}</p>
                <p class="text-xs text-slate-400">{{ $total > 0 ? round(($kuliah / $total) * 100) : 0 }}%</p>
            </div>
        </div>
        <div class="bg-white border-l-4 border-amber-500 border border-slate-200 rounded-2xl p-5 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-black text-amber-600">{{ $wirausaha }}</p>
                <p class="text-xs text-slate-400">{{ $total > 0 ? round(($wirausaha / $total) * 100) : 0 }}%</p>
            </div>
        </div>
        <div class="bg-white border-l-4 border-slate-400 border border-slate-200 rounded-2xl p-5 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-black text-slate-600">{{ $belum }}</p>
                <p class="text-xs text-slate-400">{{ $total > 0 ? round(($belum / $total) * 100) : 0 }}%</p>
            </div>
        </div>
    </div>
    ...
    @if ($total > 0)
        <div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">
            <h3 class="font-bold text-slate-800 mb-4">Persentase Penyerapan Alumni</h3>
            <div class="w-full max-w-md mx-auto" style="height: 250px;">
