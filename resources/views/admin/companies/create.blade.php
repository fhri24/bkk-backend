...
<div class="p-6 max-w-3xl">
    ...
    <form action="{{ route('admin.companies.store') }}" method="POST" class="space-y-5 bg-white rounded-3xl border border-slate-200 p-6 shadow-sm">
        ...
        <div>
            ...
            <input type="text" name="company_name" id="company_name" value="{{ old('company_name') }}" required class="mt-2 w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-100" placeholder="PT. Maju Jaya">
        </div>

        <div class="grid gap-4 lg:grid-cols-2">
            <div>
                <label for="industry" class="block text-sm font-semibold text-slate-700">Industri</label>
                <input type="text" name="industry" id="industry" value="{{ old('industry') }}" class="mt-2 w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-100" placeholder="Technology">
            </div>
            <div>
                <label for="contact_person" class="block text-sm font-semibold text-slate-700">Contact Person</label>
                <input type="text" name="contact_person" id="contact_person" value="{{ old('contact_person') }}" class="mt-2 w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-100" placeholder="Budi Santoso">
            </div>
        </div>
        ...
        <div class="grid gap-4 lg:grid-cols-2">
            <div>
                ...
                <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="mt-2 w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-100" placeholder="021-123456">
            </div>
            <div>
        ...
        <div>
            ...
            <textarea name="address" id="address" rows="4" class="mt-2 w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-100" placeholder="Jakarta Selatan">{{ old('address') }}</textarea>
        </div>
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
            <button type="submit" class="inline-flex items-center justify-center rounded-2xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white hover:bg-blue-700 transition">
                Simpan Perusahaan & Buat Lowongan
            </button>
