...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'excel.imports.csv.input_encoding' => 'NULL',
            ...
            'filesystems.links.C:\Users\Lenovo\bkk-backend-antigrafity\public\storage' => 'string',
...
'super_admin','admin_bkk','kepala_bkk','kepala_sekolah','siswa',
'perusahaan','alumni','publik','any_admin','any_user',);
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Lenovo\\bkk-backend-antigrafity\\public\\storage',
...
'services.facebook.redirect','services.fonnte.token','session.driver','session.lifetime','session.expire_on_close',
...
'dompdf.options.enable_remote','dompdf.options.allowed_remote_hosts','dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','ide-helper.filename',
...
'signed','throttle','verified','role','admin',
'student','permission',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','example.index','example.store','example.show','example.update',
'example.destroy','applications.index','applications.store',
'applications.show','applications.update','applications.destroy','super-admins.index','super-admins.store',
'super-admins.show','super-admins.update','super-admins.destroy','companies.store',
'companies.show','companies.update','companies.destroy','home','public.beranda','public.lowongan',
'public.lowongan.detail','universal.apply','public.berita','public.berita.detail','public.acara',
'public.acara.detail','public.event.register','public.tracer','tracer.report','student.tracer.store',
'public.tutorial','alumni-stories.store','login','login.process',
'auth.google','auth.google.callback','auth.facebook','auth.facebook.callback','logout',
'profile','profile.update','alumni.home','alumni.','alumni.lowongan',
'alumni.lowongan.detail','alumni.lowongan.apply','alumni.lowongan.save','alumni.lowongan.unsave','alumni.acara',
'alumni.acara.detail','alumni.acara.daftar','alumni.applications','alumni.applications.delete','alumni.berita',
'alumni.berita.detail','publik.home','publik.','publik.lowongan','publik.lowongan.detail',
'publik.lowongan.apply','publik.berita','publik.berita.detail','publik.acara','publik.acara.detail',
'publik.acara.daftar','publik.tracer','student.home','student.','student.profile.detail',
'student.lowongan','student.saved-jobs','student.lowongan.save','student.lowongan.unsave','student.lowongan.apply',
'student.lowongan.detail','student.acara','student.acara.detail','student.acara.daftar','student.applications',
'student.applications.delete','student.tracer','student.berita','student.berita.detail','student.bantuan',
'student.tentang','admin.','admin.dashboard','admin.search','admin.publik.index',
'admin.publik.destroy','admin.news.index','admin.news.create','admin.news.store','admin.news.show',
'admin.news.edit','admin.news.update','admin.news.destroy','admin.events.index','admin.events.create',
'admin.events.store','admin.events.show','admin.events.edit','admin.events.update','admin.events.destroy',
'admin.export','admin.laporan','admin.broadcast.index','admin.companies.index','admin.companies.create',
'admin.companies.store','admin.companies.show','admin.companies.edit','admin.companies.update','admin.companies.destroy',
'admin.jobs.index','admin.jobs.create','admin.jobs.store','admin.jobs.show','admin.jobs.edit',
'admin.jobs.update','admin.jobs.destroy','admin.job-applications.index','admin.job-applications.show','admin.job-applications.update-status',
'admin.event-registrations.index','admin.event-registrations.export.csv','admin.event-registrations.export.print','admin.event-registrations.export.pdf','admin.event-registrations.update',
'admin.event-registrations.destroy','admin.students.index','admin.students.import','admin.students.show','admin.users.index',
'admin.users.update-status','admin.roles.index','admin.roles.update','admin.settings.profile','admin.settings.profile.update',
'admin.settings.majors.index','admin.settings.majors.store','admin.settings.majors.edit','admin.settings.majors.update','admin.settings.majors.destroy',
'admin.settings.years.index','admin.settings.years.store','admin.settings.years.edit','admin.settings.years.update','admin.settings.years.destroy',
'admin.reports.index','admin.reports.export.alumni.csv','admin.reports.export.jobs.csv','admin.reports.export.alumni.print','admin.reports.export.jobs.print',
'admin.activity-logs.index','admin.alumni-stories.index','admin.alumni-stories.show','admin.alumni-stories.approve','admin.alumni-stories.reject',
'admin.alumni-stories.featured','admin.alumni-stories.destroy','admin.notifications','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.activity-logs.index','admin.alumni-stories.index','admin.alumni-stories.show','admin.broadcast.index','admin.companies.create',
'admin.companies.edit','admin.companies.index','admin.companies.show','admin.dashboard','admin.events.create',
'admin.events.edit','admin.events.index','admin.events.registrations','admin.events.registrations-pdf','admin.events.registrations-print',
'admin.job-applications.index','admin.job-applications.show','admin.jobs.create','admin.jobs.edit','admin.jobs.index',
'admin.jobs.show','admin.news.create','admin.news.edit','admin.news.index','admin.publik.index',
'admin.reports.index','admin.reports.print-alumni','admin.reports.print-jobs','admin.roles.index','admin.settings.majors.edit',
'admin.settings.majors.index','admin.settings.profile','admin.settings.years.edit','admin.settings.years.index','admin.students.index',
'admin.students.show','admin.users.index','auth.login','auth.register','components.job-apply-modal',
'layouts.admin','layouts.app','layouts.footer','layouts.navbar','public.acara',
'public.acara-detail','public.beranda','public.berita','public.berita_detail','public.lowongan',
'public.lowongan-detail','public.tracer','public.tracer-report','public.tutorial','student.applications',
'student.profile','student.saved-jobs','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'C:.Users.Lenovo.bkk-backend-antigrafity.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
